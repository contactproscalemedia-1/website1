...
export function Approach() {
  ...
  return (
    <section id="approach" className="protocol-section px-5 py-28 sm:px-8 sm:py-36 lg:px-14 lg:py-48">
      <div className="grid gap-14 lg:grid-cols-[.72fr_1.28fr] lg:gap-24">
        <div className="lg:sticky lg:top-40 lg:h-fit">
          ...
          <p className="mt-8 max-w-sm text-sm leading-[1.8] text-white/45">
        ...
        <div className="border-t border-white/10">
          {protocolSteps.map((step, i) => (
            <motion.article
              ...
              className="group grid gap-6 border-b border-white/10 py-10 sm:grid-cols-[70px_180px_1fr] sm:items-start lg:py-14"
            >
              ...
              <p className="text-sm leading-[1.85] text-white/48 transition-colors group-hover:text-white/72">{step.desc}</p>
            </motion.article>
          ))}
